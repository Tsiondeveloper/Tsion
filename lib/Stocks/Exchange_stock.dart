  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
            child: Text("Exchange",style: TextStyle(fontSize: 16, color: notifier.textColor))),
        actions: [
          Padding(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color:
                    tap1 == 0 ? const Color(0xffFE9900) : notifier.textField)),
        child: Column(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color:
                    tap1 == 1 ? const Color(0xffFE9900) : notifier.textField)),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Padding(
