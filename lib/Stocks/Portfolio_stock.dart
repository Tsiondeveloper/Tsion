                            ...
                            children: [
                              _password
                                  ? const Text(
                                      "\$12,768.00",
                                      style: TextStyle(
                                          fontSize: 32, color: Color(0xffFFFFFF),fontFamily: "Manrope-Bold"),
                                    )
                                  : const Text(
                                      '  ***********',
                                      style: TextStyle(
                      ...
                      children: [
                        Column(
                          children: [
                            GestureDetector(
                              onTap:(){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const Buy_stock(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const History_stock(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
                                decoration: BoxDecoration(
                                    ...
                                    color: Colors.purpleAccent.withOpacity(0.3)),
                                child: Center(
                                    child: Image.asset("assets/images/Recieve.png",
                                        scale: 2.5)),
                              ),
                            ),
                            AppConstants.Height(5),
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const Sell_stock(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
                                decoration: BoxDecoration(
                                    ...
                                    color: Colors.purpleAccent.withOpacity(0.3)),
                                child: Center(
                                    child: Image.asset("assets/images/buy_sell.png",
                                        scale: 2.5)),
                              ),
                            ),
                            AppConstants.Height(5),
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const Exchange_stock(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        icon: Padding(
                          ...
                          child: Image.asset("assets/images/Search.png",scale: 3) /*Icon(Icons.search, color: notifier.textFieldHintText)*/,
                        ),
                        hintText: "Search asset...",
                        hintStyle: TextStyle(color: notifier.textFieldHintText, fontSize: 16),
                        ...
                        children: [
                          ...
                          const Row(
                            children: [
                              ...
                              Spacer(),
                              Text("Gain/Loss",style: TextStyle(color: Color(0xff64748B),fontSize: 12,fontFamily: "Manrope-Regular"),)
                            ],
                          ),
                          Row(
                            children: [
                              Text(" \$4,987.00",
                                  style: TextStyle(
                                      ...
                                      color: notifier.textColor)),
                              const Spacer(),
                              const Text("+1,897.00",style: TextStyle(fontFamily: "Manrope-Bold",fontSize: 14,color: Color(0xff1DCE5C)),)
                            ],
                          )
                        ],
                      ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              Image.asset("assets/images/ABNB Chart.png",
                                  height: 42, width: 100,color:  const Color(0xff1e82c81)),
                            ],
                          ),
                          AppConstants.Height(20),
                          Container(
                            ...
                            children: [
                              Text(" \$2,432.00",
                                  style: TextStyle(
                                      ...
                                      color: notifier.textColor)),
                              const Spacer(),
                              const Text("-562.00",style: TextStyle(fontFamily: "Manrope-Bold",fontSize: 14,color: Color(0xff1E82C81)),)
                            ],
                          )
                        ],
                      ),
