            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: notifier
                      .textField, /*border: Border.all(color: Color(0xffFE9900))*/
                ),
                child: TextField(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            leading:Container(
                              ...
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                image: DecorationImage(image: AssetImage(data.image_),
                                  fit: BoxFit.cover,),
                              ),
                            ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15),
                                  border: Border.all(
                                      color: selectedFilter == 0 ? const Color(0xffFE9900) : notifier.getContainerBorder, )),
                              child: Row(
                                children: [
                                  Padding(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15),
                                  border: Border.all(
                                    color: selectedFilter == 1 ? const Color(0xffFE9900) : notifier.getContainerBorder,)),
                              child: Row(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(left: 10),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15),
                                  border: Border.all(
                                      color: selectedFilter == 2 ? const Color(0xffFE9900) : notifier.getContainerBorder,)),
                              child: Row(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(left: 10),
