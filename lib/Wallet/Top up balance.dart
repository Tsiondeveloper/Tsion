    ...
    return Scaffold(
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          height:40,
                          width:40,
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(30),color: notifier.getContainerBorder),
                          child: const Image(
                              image: AssetImage("assets/images/Bank America icon.png"),
                              height: 30,width: 30),
                        ),
                        ...
                        const Padding(
                          ...
                          child: Column(
                            children: [
                             Text("Change",style: TextStyle(fontSize: 12,fontFamily: "Manrope-Bold",color: Color(0xffFE9900)),)
                            ],
                          ),
                        ),
                      ],
      ...
      bottomNavigationBar: Padding(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => const Top_payment(),));
          },
          child: Container(
            height: 56,
            width: 370,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),color: const Color(0xffFE9900),),
            child: const Center(child: Text("Deposit Preview",style: TextStyle(fontSize: 18,color: Colors.white,fontFamily: "̌Manrope-Bold"))),
          ),
        ),
      ),
    );
