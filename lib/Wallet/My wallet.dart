                      ...
                      children: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: const Color.fromARGB(255, 123, 122, 123).withOpacity(0.3)),
                                child: const Center(
                                    child: Icon(
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const Transfer_balance(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const Recevie_balance(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
