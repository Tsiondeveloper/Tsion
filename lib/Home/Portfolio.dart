              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),border: Border.all(color: const Color(0xff64748B))),
                    child: Padding(
      ...
      child: Column(
        children: [
          SfCartesianChart(
            ...
            series: <ChartSeries>[
              ColumnSeries<_ChartData1,double>(dataSource: data1,
