                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: const Color(0xffFE9900),
                      border: Border.all(color: notifier.isDark?const Color(0xff0F172A):Colors.white,width: 1)
                    ),
      ...
      Padding(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: const Center(child: Text("Save Change",style: TextStyle(fontSize: 16,color: Colors.white,fontFamily: "̌Manrope-Bold"))),
          ),
        ),
      ),
