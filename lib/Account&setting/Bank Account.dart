    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Bank Account",style: TextStyle(color: Color(0xff64748B),fontSize: 15,fontFamily: "Manrope-Bold"),),
            AppConstants.Height(20),
            GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const Bank_detail(),));
              },
              child: Container(
                height: height/9,
                // width: 365,
            ...
            AppConstants.Height(20),
            const Text("E-wallet",style: TextStyle(color: Color(0xff64748B),fontSize: 15,fontFamily: "Manrope-Bold"),),
            AppConstants.Height(20),
            GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const Bank_detail(),));
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              AppConstants.Height(10),
                              const Text("helenasarapova@mail.com",
                                  style: TextStyle(
                                      color: Color(0xff64748B), fontSize: 13)),
                            ],
                          ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => const Bank_account_add_bank(),));
          },
          child: Container(
            height: 56,
            // width: 370,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),color: const Color(0xffFE9900),),
            child: const Center(child: Text("Add Bank Account/E-wallet",style: TextStyle(fontSize: 16,color: Colors.white,fontFamily: "̌Manrope-Bold"))),
          ),
        ),
      ),
    );
