          ...
          actions: [
            Center(
              child: OutlinedButton(
                ...
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const Get1(),));
                },
                style: ButtonStyle(side: MaterialStatePropertyAll(BorderSide(color: notifier.outlinedButtonColor))),
                child: Text(
                  "Skip",
                  style: TextStyle(fontSize: 17, color: notifier.outlinedButtonColor),
                ),
              ),
            ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "Your global portfolio. Crypto, NFTs, gold, stocks. Securely managed in one app.",
                        style: TextStyle(
                            fontSize: 16,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppConstants.Height(10),
                      const Text(
                        "Set up automatic payments on different assets overtime.",
                        style: TextStyle(
                            fontSize: 16,
                            color: Color(0xff64748B),
                            fontFamily: "Manrope-Medium"),
                      ...
                      //       child:  Center(
                      //         child: Text("Browse Assets",
                      //             style: TextStyle(color: Color(0xffFE9900), fontSize: 16,fontFamily: "Manrope-Bold")),
                      //       ),
                      //     ),
                      //   ),
                      // ),
