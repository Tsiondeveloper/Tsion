...
class ColorNotifire with ChangeNotifier {
  ...
  get outlinedButtonColor=> isDark?const Color(0xffFE9900):const Color(0xffFE9900);
  ...
  get checkBox => isDark ? const Color(0xffFE9900) : const Color(0xffCBD5E1);
  get radioButton => isDark ? const Color(0xffFE9900) : const Color(0xffCBD5E1);
  ...
  get tabBar3 => isDark?const Color(0xffFE9900) : const Color(0xffF8F5FF);
  ...
  get tabBarText1 => isDark?const Color(0xffFE9900) : const Color(0xffFE9900);
