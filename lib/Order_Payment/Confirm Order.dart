    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Order Preview",
          style: TextStyle(
              fontFamily: "Manrope-Bold", fontSize: 16, color: notifier.textColor),
        ),
        backgroundColor: notifier.background,
        elevation: 0,
      ),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        const Text("BTC price",style: TextStyle(color: Color(0xff64748B),fontSize: 14)),
                        const Spacer(),
                        Text(" 0.061 BTC",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Medium"),)
                      ],),
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(" 1,245.00",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Medium"),)
                      ],),
                    Divider(
                      thickness: 1,
                      color: notifier.divider,
                    ...
                    Row(
                      children: [
                        const Text("Payment method",style: TextStyle(color: Color(0xff64748B),fontSize: 14)),
                        const Spacer(),
                    ...
                    Row(
                      children: [
                        const Text("Financial fee",style: TextStyle(color: Color(0xff64748B),fontSize: 14)),
                        const Spacer(),
                        Text(" 8.00",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Medium"),)
                      ],),
                    Divider(
                      thickness: 1,
                      color: notifier.divider,
                    ...
                    const Row(
                      children: [
                        ...
                        Spacer(),
                        Text(" Free",style: TextStyle(fontSize: 15,color: Color(0xff1DCE5C),fontFamily: "Manrope-Medium"),)
                      ],),
                    Divider(
                      thickness: 1,
                      color: notifier.divider,
                    ...
                    Row(
                      children: [
                        Text("Total buy",style: TextStyle(color: notifier.bottom,fontSize: 14,fontFamily: "Manrope-Bold")),
                        const Spacer(),
                        Text(" 1,253.00",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Bold"),)
                      ],),
                  ],
                ),
              ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => const Order_success(),));
          },
          child: Container(
            height: 56,
            width: 370,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),color: const Color(0xffFE9900),),
            child: const Center(child: Text("Buy Now",style: TextStyle(fontSize: 16,color: Colors.white,fontFamily: "̌Manrope-Bold"))),
          ),
        ),
      ),
    );
