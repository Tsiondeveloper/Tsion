  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Order Crypto",style: TextStyle(color: Colors.white,fontSize: 14,fontFamily: "Manrope-Bold")),
      ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              Text(" 1,245.00",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Bold"),)
                            ],),
                          ...
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              Text(" 0.061 BTC",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Bold"),)
                            ],),
                          Divider(
                            thickness: 1,
                            color: notifier.divider,
