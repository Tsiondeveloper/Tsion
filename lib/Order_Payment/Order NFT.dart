  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Order NFT",style: TextStyle(color: Colors.white,fontSize: 14,fontFamily: "Manrope-Bold")),
      ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      ...
                                      image: DecorationImage(image: AssetImage("assets/images/Genesis.png"),
                                        fit: BoxFit.cover,),
                                    ),
                                  ),
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      "Change",
                                      style: TextStyle(
                                          fontSize: 15, color: Color(0xffFE9900),fontFamily: "Manrope-Bold"),
                                    ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              Text(" 156.76",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Bold"),)
                            ],),
                          ...
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              Text(" 0.100 ETH",style: TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "Manrope-Bold"),)
                            ],),
                          Divider(
                            thickness: 1,
                            color: notifier.divider,
