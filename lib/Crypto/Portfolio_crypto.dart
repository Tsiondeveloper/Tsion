                      ...
                      children: [
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const Sell_crypto(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const History_crypto(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const Exchange(),));
                              },
                              child: Container(
                                height: 56,
                                width: 56,
