    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: GestureDetector(
          onTap: () {
           showConfirmationDialog(context, "Are you sure you want to go through with the conversion", "Successfully exchanged.");
          },
          child: Container(
            height: 56,
            width: 370,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: tap == 0 ? const Color(0xffFE9900) : notifier.textField)),
        child: Column(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            color: notifier.textField,
            border: Border.all(
                color: tap == 1 ? const Color(0xffFE9900) : notifier.textField)),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Padding(
