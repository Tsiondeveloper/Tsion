        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const see_all(),));
                },
                child: const Text(
                  "See All Assets",
                  style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const Trending_see(),));
                    },
                    child: const Text(
                      "See all",
                      style: TextStyle(fontSize: 14, color: Color(0xffFE9900)),
                    ),
                  )
                ],
              ),
