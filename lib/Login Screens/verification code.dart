        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
               ...
               child: Container(
                 height: height/11,
                 decoration: BoxDecoration(color: const Color(0xffFE9900),borderRadius: BorderRadius.circular(15)),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child:const Center(child: Text("Resend Code",style: TextStyle(fontSize: 16,color: Color(0xffFE9900),fontFamily: "Manrope-Bold"))) ,
              ),
            ),
            // Container(
            //   height: 56,
            ...
            //   child: Center(
            //       child: Text("",
            //           style: TextStyle(fontSize: 16, color: Color(0xffFE9900),fontFamily: "Manrope-Bold"))),
            // )
          ],
        ),
      ),
