            ...
            Container(
                ...
                child: Column(
                  children: [
                    ...
                    const Spacer(),
                    Image.asset("assets/images/WorldStreetLogox.png",color: notifier.isDark ? Colors.white : null,height: height/10),
                    const Spacer(),
                ...
                children: [
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(hintText: "Phone Number",border: const OutlineInputBorder(borderSide: BorderSide.none),hintStyle: TextStyle(color: notifier.textFieldHintText)),
                    ),
                  ),
