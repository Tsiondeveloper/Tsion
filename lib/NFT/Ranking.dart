                            ...
                            return StatefulBuilder(
                              builder: (context, setState) {
                                return Container(
                                  ...
                                  decoration: BoxDecoration(borderRadius: const BorderRadius.only(topLeft: Radius.circular(20),topRight: Radius.circular(20)),color: notifier.background,),
                                  child: Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Checkbox(
                                                ...
                                                checkColor: const Color(0xffFE9900),
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(image: AssetImage(data1[index]['image']),
                                      fit: BoxFit.cover,),
                                  ),
                                ),
