                                  ...
                                  children: [
                                    ...
                                    AppConstants.Height(5),
                                     Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          const Text("0.029 ETH",style: TextStyle(fontSize: 11,color: Color(0xffFE9900),fontFamily: "Manrope-SemiBold"),),
                                          const Spacer(),
                                  ...
                                  children: [
                                   const Padding(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          const Text("0.500 ETH",style: TextStyle(fontSize: 11,color: Color(0xffFE9900),fontFamily: "Manrope-SemiBold"),),
                                          const Spacer(),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                   ...
                                   const Text("53.9%", style: TextStyle(color: Color(0xff1DCE5C), fontSize: 13),
                                    ),
                                  ],
                                ),
                              ],
                            ...
                            Column(
                              children: [
                                ...
                                Row(
                                  children: [
                                    Image.asset("assets/images/up-arrow.png",height: 10,width: 12),
                                   const Text("60.9%", style: TextStyle(color: Color(0xff1DCE5C), fontSize: 13),
                                    ),
                                  ],
                                ),
                              ],
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            const Image(image: AssetImage("assets/images/SOL.png"), height: 40,width: 40),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                 Text(
